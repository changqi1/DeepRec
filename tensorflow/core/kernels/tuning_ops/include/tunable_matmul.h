...
#define FUNC_DEF_HEAD(name)                                                                             \
  ...
  {                                                                                                     \
    ShowLog("start doing FUNC_DEF_HEAD!!!");                                                            \
...
#define FUNC_DEF_TAIL                                                                                            \
  ...
  ShowLog("end doing FUNC_DEF_HEAD!!!");                                                                         \
  }                                                                                                              \
...
public:
  ...
  void SetParams(int M, int N, int K, int lda, int ldb, int ldc, int nthreads = -1){
    SetParams(M, N, K, lda, ldb, ldc, nullptr, nullptr, nullptr, nthreads);
  }

  void SetParams(int M, int N, int K, int lda, int ldb, int ldc, const T *A, const T *B, T *C, int nthreads = -1){
    mmconfig.mmsize.m = M;
    mmconfig.mmsize.n = N;
    mmconfig.mmsize.k = K;
